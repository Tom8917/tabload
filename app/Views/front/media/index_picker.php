        ...
        <div class="d-flex flex-wrap gap-2 align-items-center">
            <?php if (!$isLegacy): ?>
                ...
                <a class="chip <?= $filter === 'image' ? 'active' : '' ?>"
                   href="<?= esc(currentNavUrlPicker($currentFolderId, 'image', $sort)) ?>"><i
                            class="fa-solid fa-image"></i> Images</a>
                <a class="chip <?= $filter === 'document' ? 'active' : '' ?>"
                   href="<?= esc(currentNavUrlPicker($currentFolderId, 'document', $sort)) ?>"><i
                            class="fa-solid fa-file"></i> Documents</a>
            ...
            <div class="p-3">
                ...
                <div class="mt-3 d-flex flex-wrap gap-2 align-items-center">
                    ...
                    <div class="ms-auto d-flex gap-2">
                        ...
                        <button id="btnUpload" type="button" class="btn btn-success rounded-pill" disabled>Uploader
                        </button>
                    </div>
                </div>
