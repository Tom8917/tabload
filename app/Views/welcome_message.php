...
<section>
    ...
    <p>Pour continuer, cliquez <span><a href=<?= base_url("/admin")?>>ici</a></span>.</p>
    ...
    <script>
        var options = {
            strings: ["Bienvenue sur mon application web.", "Connectez-vous pour continuer l'accès.", "Il va s'effacer et recommencer.", "Encore et encore..."],
            typeSpeed: 50,     // Vitesse de frappe
            backSpeed: 50,      // Vitesse de suppression
            backDelay: 2500,    // Délai avant la suppression
