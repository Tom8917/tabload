<div class="card">
    <div class="card-header d-flex justify-content-between align-items-center">
        <h4>Liste des
            <mark>Matériels Médicales</mark>
        </h4>
        <a href="<?= base_url('/admin/materialmedical/new'); ?>"><i class="fa-solid fa-plus"></i></a>
    </div>
    <div class="card-body">
        <div class="table-responsive">
            <table id="tableMaterialMedicals" class="table table-hover">
                <thead>
                <tr>
                    <th>ID</th>
                    <th>Type</th>
...
<script>
    $(document).ready(function () {
        ...
        var dataTable = $('#tableMaterialMedicals').DataTable({
            "responsive": true,
            "processing": true,
            "serverSide": true,
            "pageLength": 10,
            ...
            "ajax": {
                "url": baseUrl + "admin/materialmedical/SearchMaterialMedical",
                "type": "POST"
            },
            "columns": [
                {"data": "id"},
                {"data": "materialmedicaltype_type"},
                {"data": "materialmedicalbrand_marque"},
                {"data": "reference"},
                {"data": "nserie"},
                {"data": "center_ville"},
                {"data": "user_email"},
                ...
                },
                {
                    ...
                    render: function (data) {
                        return `<a href="${baseUrl}admin/materialmedical/${data}" class="text-primary" title="Modifier">
        ...
        $(document).on("click", ".delete-btn", function (e) {
            e.preventDefault();
            var materialmedicalId = $(this).data("id");
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    window.location.href = baseUrl + "admin/materialmedical/delete/" + materialmedicalId;
                }
            });
        });
    });
...
<style>
    #tableMaterialMedicals th, #tableMaterialMedicals td {
        white-space: nowrap;
