<header class="header header-sticky p-0 mb-4">
    <div class="container-fluid border-bottom px-4">
        ...
        <!--                    <a href="--><?php //= base_url('/Dashboard') ?><!--" class="btn me-4 ms-4 sub-menu"><i class="fa-solid fa-house"></i></a>-->
        <!--                    <a href="--><?php //= base_url('/ticket') ?><!--" class="btn me-4 sub-menu"><i class="fa-solid fa-ticket"></i></a>-->
        <!--                --><?php //elseif ($user->id_permission == 2): ?>
        <!--                    <a href="--><?php //= base_url('/Dashboard') ?><!--" class="btn me-4 ms-4 sub-menu"><i class="fa-solid fa-house"></i></a>-->
        <!--                    <a href="--><?php //= base_url('/admin/material') ?><!--" class="btn me-4 sub-menu"><i class="fa-solid fa-network-wired"></i></a>-->
        <!--                    <a href="--><?php //= base_url('/admin/materialmedical') ?><!--" class="btn me-4 sub-menu"><i class="fa-solid fa-suitcase-medical"></i></a>-->
        <!--                    <a href="--><?php //= base_url('/ticket') ?><!--" class="btn me-4 sub-menu"><i class="fa-solid fa-ticket"></i></a>-->
        <!--                --><?php //else : ?>
        <!--                    <a href="--><?php //= base_url('/admin') ?><!--" class="btn ms-3 me-2 sub-menu"><i class="fa-solid fa-house"></i></a>-->
        <!--                    <a href="--><?php //= base_url('/admin/task') ?><!--" class="btn me-2 sub-menu"><i class="fa-solid fa-list-check"></i></a>-->
        <!--                    <a href="--><?php //= base_url('/admin/user') ?><!--" class="btn me-2 sub-menu"><i class="fa-solid fa-users"></i></a>-->
        <!--                    <a href="--><?php //= base_url('/admin/material') ?><!--" class="btn me-2 sub-menu"><i class="fa-solid fa-network-wired"></i></a>-->
        <!--                    <a href="--><?php //= base_url('/admin/materialmedical') ?><!--" class="btn me-2 sub-menu"><i class="fa-solid fa-suitcase-medical"></i></a>-->
        <!--                    <a href="--><?php //= base_url('/admin/ticket') ?><!--" class="btn me-3 sub-menu"><i class="fa-solid fa-ticket"></i></a>-->
        <!--                --><?php //endif; ?>
        <!--            </div>-->
        <!--        </div>-->
